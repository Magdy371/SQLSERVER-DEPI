...
/*SELF SEARCHED 
Examples Of Full participation and Partial participation

1- Full participation
	Every instance of Entity must participate in a relation ship 
	Like Employee and Department
	As each employee must e assgned into a department
	
2- Partial participate
	partial participation means not every instance of intity  needs to paticipate in a relationship
	As if we have Employee and parking space relationship 
	where only some employees have assigned parking spaces, this would be partial participation
*/
--Example in T-SQL OF fULL participation
...
CREATE TABLE ParkingSpace (
    ...
    SpaceLocation NVARCHAR(100) NOT NULL
);

CREATE TABLE Employee (
    EmployeeID INT PRIMARY KEY,
    EmployeeName NVARCHAR(100) NOT NULL,
    SpaceID INT NULL, -- This can be NULL, meaning not all employees need to have a parking space
